    ...
    <group dispose={null} ref={modelGroupRef} {...props}>
      ...
      <group position={[0.551, 0, -3.143]}>
        ...
        <mesh
          ...
          scale={1.293}
        >
          <mesh castShadow={true} geometry={nodes.Plane024.geometry} material={materials.Metal} receiveShadow={true} />
          <mesh
            castShadow={true}
        ...
        >
          ...
          <mesh castShadow={true} geometry={nodes.Plane041.geometry} material={materials.Glass} receiveShadow={true} />
          <mesh
            castShadow={true}
      ...
      <group position={[0.144, 0, -0.886]} scale={1.049} visible={!projectorZoomed && !screenZoomed}>
        ...
        <group position={[0, 1.232, 0.613]} scale={1.128}>
          <mesh castShadow={true} geometry={nodes.Plane072.geometry} material={materials.White} receiveShadow={true} />
          <mesh
            castShadow={true}
        ...
        <group position={[0.746, 1.685, 0.023]} scale={0.918}>
          <mesh castShadow={true} geometry={nodes.Plane074.geometry} material={materials.White} receiveShadow={true} />
          <mesh
            castShadow={true}
      ...
      >
        ...
        <mesh
          ...
          rotation={[0, 0, Math.PI / 2]}
        />
        <mesh castShadow={true} geometry={nodes.Plane063.geometry} material={materials['Black']} receiveShadow={true} />
