...
import { Group, Material, Mesh, MeshStandardMaterial, MeshBasicMaterial } from 'three';
...
type GLTFResult = GLTF & {
  nodes: {
    ...
    Book0002_1: Mesh;
    Book0002_2: Mesh;
    ['abstract-expressionism-abstract-painting-acrylic-paint-1585325']: Mesh;
  };
  materials: {
    ...
    ['abstract-expressionism-abstract-painting-acrylic-paint-1585325']: MeshStandardMaterial;
  };
};
...
const Room: React.FC<GroupProps> = (props) => {
  ...
  return (
    <group dispose={null} ref={modelGroupRef} {...props}>
      ...
      <mesh castShadow receiveShadow geometry={nodes.Windows_Frames.geometry} material={materials.Wood} />
      <mesh
        castShadow
        ...
        <mesh castShadow receiveShadow geometry={nodes.Table_Legs.geometry} material={materials.Steel} />
      </mesh>
      <mesh
        castShadow
      ...
      <mesh
        ...
        receiveShadow>
      >
        <mesh castShadow receiveShadow geometry={nodes.Stereo_Table_Legs.geometry} material={materials['Wood Dark']} />
      </mesh>
      <mesh
        castShadow
        ...
        receiveShadow>
      >
        <mesh castShadow receiveShadow geometry={nodes.Sofa_Cushions.geometry} material={materials.Sofa} />
        <mesh castShadow receiveShadow geometry={nodes.Sofa_Legs.geometry} material={materials.Steel} />
      </mesh>
      <mesh
        castShadow
        ...
        <mesh
          ...
          receiveShadow
        />
        <mesh castShadow receiveShadow geometry={nodes.Player_Legs.geometry} material={materials.Steel} />
        <mesh
          castShadow
        ...
        <group position={[0, 0.14945, 0]}>
          <mesh castShadow receiveShadow geometry={nodes.Circle003.geometry} material={materials.Black} />
          <mesh castShadow receiveShadow geometry={nodes.Circle003_1.geometry} material={materials.White} />
        </group>
        <mesh
          castShadow
      ...
      <mesh
        ...
        scale={1.05454}>
      >
        <mesh castShadow receiveShadow geometry={nodes.Arm_Rest.geometry} material={materials.Steel} />
        <mesh castShadow receiveShadow geometry={nodes.Arm_Rest_Cushiion.geometry} material={materials.Sofa} />
        <mesh castShadow receiveShadow geometry={nodes.Chair_Legs.geometry} material={materials.Steel} />
      </mesh>
      <mesh
        castShadow
        ...
        scale={1.12938}>
      >
        <mesh castShadow receiveShadow geometry={nodes.Display.geometry} material={materials['Black.002']} />
        <mesh castShadow receiveShadow geometry={nodes.Monitor.geometry} material={materials.Steel} />
        <mesh castShadow receiveShadow geometry={nodes.Monitor_Stand.geometry} material={materials.Steel} />
      </mesh>
      <mesh
        castShadow
        ...
        scale={0.89289}>
      >
        <mesh castShadow receiveShadow geometry={nodes.tree.geometry} material={materials.Plant} scale={0.59851}>
          <mesh castShadow receiveShadow geometry={nodes.leaves.geometry} material={materials.Leaves} />
        </mesh>
        <mesh castShadow receiveShadow geometry={nodes.Vert001.geometry} material={materials.Dirt} />
      </mesh>
      <group position={[0.06978, 0, 1.98886]}>
        <mesh castShadow receiveShadow geometry={nodes.Vert002_1.geometry} material={materials['Wood Dark']} />
        <mesh castShadow receiveShadow geometry={nodes.Vert002_2.geometry} material={materials.Stump} />
        <mesh castShadow geometry={nodes.Plane.geometry} material={materials.Steel} receiveShadow />
      </group>
      <group position={[-3.73911, 3.03058, -0.95863]} rotation={[0, Math.PI / 2, 0]} scale={1.3793}>
        <mesh geometry={nodes.Book0_1.geometry} material={new MeshStandardMaterial({
            color: randomColor({ luminosity: 'dark', seed: 'book_1' }),
            roughness: 0.5,
            metalness: 0.3
          })} />
        <mesh castShadow receiveShadow geometry={nodes.Book0_2.geometry} material={materials.White} />
        <group position={[0.03851, 0, -0.02097]} scale={[1.39602, 0.90597, 1]}>
          <mesh castShadow receiveShadow geometry={nodes.Book0_1.geometry} material={new MeshStandardMaterial({
            color: randomColor({ luminosity: 'dark', seed: 'book_1' }),
            roughness: 0.5,
            metalness: 0.3
          })} />
      ...
      <mesh
        ...
        scale={0.1367}>
        <mesh castShadow receiveShadow geometry={nodes.Plane044.geometry} material={materials['Black.002']} />
        <mesh
          castShadow
      ...
      <group position={[-3.55772, 3.92696, -1.2431]} rotation={[0.0003, 0.2232, -0.00037]} scale={1.16723}>
        <mesh castShadow receiveShadow geometry={nodes.Plane029.geometry} material={materials.White} />
        <mesh castShadow receiveShadow geometry={nodes.Plane029_1.geometry} material={materials['Black.001']} />
      </group>
      <mesh
        castShadow
      ...
      <group position={[1.07453, 1.71883, -3.1391]} rotation={[0, -1.10507, 1.57056]} scale={1.5561}>
        <mesh castShadow receiveShadow geometry={nodes.Book0002_1.geometry} material={materials['Black.001']} />
        <mesh castShadow receiveShadow geometry={nodes.Book0002_2.geometry} material={materials.White} />
      </group>
      <mesh
        castShadow
        ...
        scale={1.8889}
      />
      <mesh castShadow geometry={nodes.Plane_2.geometry} material={materials.White} receiveShadow />
      <mesh castShadow geometry={nodes.Plane_3.geometry} material={materials.Floor} receiveShadow />
    </group>
  );
};
